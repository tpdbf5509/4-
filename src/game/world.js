...
export const ARENA_PATTERNS = [
  { id: "slam",  name: "내리치기", tell: 0.95, dmg: 1.0, note: "한 곳을 크게 내리친다" },
  { id: "sweep", name: "휩쓸기",   tell: 1.2,  dmg: 0.9, note: "둘레를 쓸어버린다 — 품 안이나 바깥으로" },
  { id: "stomp", name: "발구르기", tell: 0.85, dmg: 0.8, note: "세 곳을 동시에 짓밟는다" },
];
